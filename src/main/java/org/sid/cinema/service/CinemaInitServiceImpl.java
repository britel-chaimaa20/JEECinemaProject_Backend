...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initCategories() {
		Stream.of("Crime", "Drama", "Fiction", "Thriller","Horror").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("Divergent","Joker","Spider Man","Bumble Bee","XMen","Enola Holmes").forEach(titreFilm->{
			Film film = new Film();
	...
	public void initProjections() {
		double[] prices = new double[] {30, 50, 60, 80, 100};
